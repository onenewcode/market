export const theme = {
  ...
  layout: {
    ...
    mainContainer: "relative min-h-screen overflow-x-clip bg-bg1 text-foreground",
    contentWrapper: "relative z-10 mx-auto flex min-h-screen max-w-4xl flex-col gap-10 border-x border-border-low px-6 py-16",
    header: "space-y-3",
  ...
  button: {
    ...
    variants: {
      primary: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm px-6 py-2",
      secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 px-6 py-2",
      outline: "border border-border-low hover:bg-muted/10 bg-transparent px-6 py-2",
      ghost: "hover:bg-muted/10 text-foreground/80 hover:text-foreground px-4 py-2",
      link: "text-sm underline text-muted hover:text-foreground p-0 h-auto",
      connector: "flex items-center gap-3 rounded-lg border border-border bg-card p-4 transition-colors hover:bg-accent/5",
    },
    nav: {
